...
using TfL_Walking_Distance_Version3.Interface;
using System.Diagnostics;

namespace TfL_Walking_Distance_Version3.View
{
    class TfL_App : ICustomer, IManager
    {
                                        ...
                                        if (appUser.UserType == "Manager")
                                        {
                                            switch (val6)
                                            {
                                                case 1:
                                                    ...
                                                    Console.WriteLine("");
                                                    Console.WriteLine($"Time taken to Print list of of Impossible Route = {time5.Milliseconds} Milliseconds");
                                                    Console.ReadLine();
                                                    break;
                                                case 2:
                                                    ...
                                                    while (e < 1)
                                                    {
                                                        ...
                                                        Console.WriteLine("");
                                                        Console.WriteLine($"Time taken to Print list of of Impossible Route = {time4.Milliseconds} Milliseconds");
                                                    }
                                                    Console.ReadLine();
                                                    break;
                                                case 3:
                                                    ...
                                                    Console.WriteLine("");
                                                    Console.WriteLine($"Time taken to Print list of of Impossible Route = {time3.Milliseconds} Milliseconds");
                                                    Console.ReadLine();
                                                    break;
                                                case 4:
                                                    Console.WriteLine("");
                                            ...
                                            case 2:
                                                ...
                                                while (c < 1)
                                                {
                                                    ...
                                                    if (CheckTubeName(varName))
                                                    {
                                                        ...
                                                        Console.WriteLine("");
                                                        Console.WriteLine($"Time taken to Display tube {varName} information = {time1.Milliseconds} Milliseconds");
                                                        c++;
                                                        Console.ReadLine();
                                                    }
                                                    else
